...
func (p *BoolCheck) CollectInput() {
    fmt.Println("I am validating input!")
}

func (p *BoolCheck) WriteToDB() {
    fmt.Println("I am writing to the DB!")
}
...
func (p *IntCheck) CollectInput() {
    fmt.Println("I am writing to the DB!")
}

func (p *IntCheck) WriteToDB() {
    fmt.Println("I am writing to the DB!")
}
...
func (p *RangeCheck) CollectInput(name string) {
...
var checkinCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		// Iterate through checks to create 
